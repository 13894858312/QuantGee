...
<head>
    ...
    <meta name="keywords" content="quantgee" />
            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#" data-nav-section=""><span>大盘行情</span></a></li>
                        <li><a href="#" data-nav-section=""><span>个股信息</span></a></li>
                        <li><a href="#" data-nav-section=""><span>用户登录</span></a></li>
                    </ul>
                </div>
            </nav>
        </div>
            ...
            <div class="text-inner">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        ...
                        <h2 class="animate-box">source code ：<a href="#" target="_blank" title="Free HTML5 Bootstrap Templates" class="fh5co-link">GITHUB</a></h2>
                        <div class="call-to-action">
                            <a href="#fh5co-aboutus" class="demo animate-box">About us</a>
                            <a href="#" class="download animate-box">Download Zip</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12"><br>
                    <p class="copy-right">&copy; 2017 王友运 卞纯源 卞纯源 赵德宇 All Rights Reserved. </p>
                </div>
            </div>
        </div>
    </div>
