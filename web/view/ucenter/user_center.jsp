...
<html lang="zh-cn">
	...
	<body>
		...
		<div class="info_panel day">
			<div class="control">
				<h1 class="person_pic"><a href="user_center.html" target="_blank"><i></i></a><span id="page-title">我的自选</span></h1>
				<div class="infos">
		...
		<div class="lay_out control">
			<div class="left_bar">
				...
				<ul class="outer ta-parent-box" data-taid="wdzx_dh2" data-fid="wdzx_djall">
					<li class="hqcenter">
						<a href="/marketInfo.html" target="_blank">行情中心</a>
					</li>
					<li class="clcenter">
