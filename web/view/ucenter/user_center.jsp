...
<div class="head">
    ...
    <div class="menu" id="ha5" style="border-bottom: 2px solid rgb(62, 196, 131);">
        <a class="menua" id="a5" href="../../view/ucenter/user_center.jsp" target="_blank"
           style="color: rgb(62, 196, 131);">个人中心</a>
    </div>
    <div>
...
<div class="lay_out control">
    ...
    <div class="right_content fr">
        ...
        <div id="myStock" class="data_panel ta-parent-box" data-taid="wdzx_hq" data-fid="wdzx_djall"
             style="display: block;">
    ...
    <div id="myStrategy" class="right_bar_tit" style="display: none;">
        ...
        <a class="ta-own-box" href="../../view/strategy/strategy.jsp" data-taid="wdgz_wdzg" data-fid="wdgz_djall"
           target="_blank">进入策略研究&gt;&gt;</a>
    </div>
    ...
    <div id="accountSetting" class="right_bar_tit" style="display: none;float: left;width: 902px;">
        ...
        <div id="userInfo_accountID" style="margin-top: 20px;">
            <div style="text-align: center;width: 500px;margin:10px auto;">
                ...
                <input id="accountIDInfo" type="text"
                       style="width: 300px;margin-left:10px; border: 1px solid rgb(200,200,200);border-radius: 3px;height: 35px;"
                       readonly="readonly"/>
            ...
            <div style="text-align: center;width: 500px;margin: 10px auto;">
                ...
                <input id="usernameInfo" type="text"
                       style="width: 300px;margin-left:10px; border: 1px solid rgb(200,200,200);border-radius: 3px;height: 35px;"
                       readonly="readonly">
                <button onclick="changeInfo('usernameInfo')"
                        style="margin-left: 20px; height: 39px; width: 64px;background-color: white;border: 1px solid lightblue;border-radius: 6px;">
                    修改
                </button>
            </div>
            <div style="text-align: center;width: 500px;margin: 10px auto;">
                ...
                <input id="phoneNumber" type="text"
                       style="width: 300px;margin-left:10px; border: 1px solid rgb(200,200,200);border-radius: 3px;height: 35px;"
                       readonly="readonly">
                <button onclick="changeInfo('phoneNumber')"
                        style="margin-left: 20px; height: 39px; width: 64px;background-color: white;border: 1px solid lightblue;border-radius: 6px;">
                    修改
                </button>
            </div>
            <div style="text-align: center;width: 500px;margin:10px auto;">
                ...
                <input id="passwordInfo" type="password"
                       style="width: 300px;margin-left:10px; border: 1px solid rgb(200,200,200);border-radius: 3px;height: 35px;"
                       readonly="readonly">
                <button id="changePasswordBut" onclick="changePassword()"
                        style="margin-left: 20px; height: 39px; width: 64px;background-color: white;border: 1px solid lightblue;border-radius: 6px;">
                    修改密码
                </button>
            </div>
            <div style="text-align: center;width: 500px;margin: 10px auto;">
                <button onclick="submitInfoChagnes()" id="changeInfoButton" class="button"
                        style="margin-left: 20%; height: 39px; width: 50px;background-color: white;border: 1px solid lightblue;border-radius: 6px;display: none;">
                    提交
                </button>
            </div>
        </div>
