		...
		<div id="showcasebg">
			<div class="loginbox" id="loginbox">
				...
				<form action="login" onsubmit="return validate_login_form()" method="post">
					<input type="text" id="login_userName" name="accountVO.accountID" maxlength="20" onfocus=temp(this) onblur="if(this.value=='') {this.value='请输入帐号';this.style.color='#fff';}" value="请输入帐号" />
					...
					<input type="submit" id="login_submit" class="submit" value="登录" style="width:252px;height: 48px;font-size: 20px;text-align: center;background: #3EC483;" />
				</form>
			...
			<div class="registbox" id="registbox">
				...
				<form action="register" onsubmit="return validate_register_form()" method="post">
					<input type="text" id="register_userName" name="accountVO.accountID" maxlength="20" onfocus=temp(this) onblur="if(this.value=='') {this.value='请输入帐号';this.style.color='#fff';}" value="请输入帐号" />
					...
					<input type="submit" id="register_submit" class="submit" value="注册" style="width:252px;height: 48px; margin-bottom: 0px ; font-size: 20px;text-align: center;background: #3EC483;" />
				</form>
			</div>
