...
public class MockStockData implements StockDataDao {
    ...
    public ArrayList<StockPO> getStockPOsByTimeInterval(String startdate, String endDate, String stockCode) {
        ...
        if(stockCode == "3") {
            stockPOs.add(new StockPO("3/1/17", 90, 150, 90, 8.15, 3000, 130, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/2/17", 50, 90, 40, 8.07, 300, 40,"1", "aaa", "a"));
            stockPOs.add(new StockPO("3/3/17", 10, 15, 9, 8.84, 200, 10, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/6/17", 90, 100, 70, 8.10, 10, 80, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/7/17", 300, 320, 290, 8.40, 20, 310, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/8/17", 10, 12, 5, 9.10, 50, 6, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/9/17", 5, 5, 4, 9.20, 30, 4, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/10/17", 20, 24, 19, 9.10, 20, 20, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/13/17", 40, 42, 35, 8.95, 100, 37, "1", "aaa", "a"));
            stockPOs.add(new StockPO("3/14/17", 60, 61, 50, 8.70, 2000, 52, "1", "aaa", "a"));
        } else {
